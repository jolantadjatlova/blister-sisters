...
- As a user, I need easy navigation and a user-friendly design, including a
 ...
 frustration.
 - As a user,  I want to see high quality images, engaging descriptions of hiking
...
This is a B2C website designed for women interested in joining a supportive, women-only hiking community. The site must:

- Clearly communicate the mission and values of Blister Sisters.
- Provide essential information about guided hikes, including descriptions, pricing and meeting points.
- Offer an easy and accessible way for users to sign up for hikes.
- Motivate and reassure users with warm, inclusive content and visuals.
- Be fully responsive and intuitive across mobile, tablet and desktop devices.

**Scope:**
The scope of this project was to design and develop a fully responsive, single-page website for a fictional women-only hiking group. The site needed to communicate the Blister Sisters brand, promote a sense of community and encourage participation. It includes:

- A hero banner and strong introductory message.

- An "About Us" section to establish trust and explain the group’s mission.

- Descriptions and sign-up options for three major UK hikes.

- A checklist to help users prepare for hikes.

- Interactive elements like a pricing table, Google Maps and a modal form.

- A soft, welcoming colour palette and typography that reflects the group’s supportive values.

- Full compatibility across devices (mobile, tablet and desktop).
---

### Planning Tools & Workflow

To stay organised and follow an iterative, Agile process, I used the following tools:

#### GitHub Projects (Kanban)
A Kanban board was set up in [GitHub Projects](https://github.com/users/jolantadjatlova/projects/3) to manage all tasks visually. Tasks were broken into user stories and categorised by status:  
...
|----------------|-------------|
| **Must Have**  | Core functionality (e.g., navigation, hike details, sign-up form) needed for the site to work. |
| **Should Have**| Important features that enhance the user experience (e.g., Google Maps, bundle pricing). |
| **Could Have** | Nice-to-have features if time allowed (e.g., payment integration). |
| **Won’t Have** | Features out of scope for the MVP or not feasible within the current timeframe. |
...
### Colour Scheme
The colour scheme was generated using [Coolors](https://coolors.co/ "Coolors") inspired by the website’s hero image of a mountain at sunrise. The palette reflects natural tones of morning light and earthy environment, creating a calm and welcoming atmosphere.
...
| About Us page | The About Us section introduces the Blister Sisters mission, highlighting the founders’ passion for hiking and women’s wellbeing. It emphasises the group’s focus on community, conversation and support through guided hikes in iconic UK landscapes.| ![about us](doc/about-us-page.png)
...
| Footer | The footer includes contact information, social media icons for Instagram, Facebook and Twitter, plus a copyright notice. It provides users with a clear way to connect and reinforces brand presence across all pages. | ![footer](doc/footer-page.png) |
...
|[VS Code](https://code.visualstudio.com)                          | Writing and organising all project files.| Tool
...
| As a user, I want to see high quality images, engaging descriptions of hiking trails and scenery, so I can decide if it's the right place for me to explore. | Each hike section includes a high-quality image and a detailed, inviting description of the trail. | P | ![Hikes](doc/user-story-evidence-hikes.png)           |
| As a user, I need to find hiking locations and contact details for inquiries, so I can plan my hike confidently. | The Hikes section provides detailed location info, plus contact details are available in the footer and Contact page. | P |![Meeting Points](doc/user-story-evidence-locations.png)|
| As a user, I want clear and helpful information about what to pack for a hike, so I feel safe and prepared on the day. | The Checklist section provides categorised packing lists covering essentials, clothing, weather-dependent gear and optional extras. | P |![Checklist](doc/user-story-evidence-checklist.png) |
...
_Any changes to the website can be made, committed, and pushed to GitHub._
